...
const LandingPage = () => {
  ...
  return (
    <div className="min-h-screen mesh-bg text-slate-900 dark:text-white selection:bg-indigo-500/30 font-sans">
      {/* Navigation */}
      <Navbar />
      {/* Hero Section */}
      <section className="relative pt-32 pb-20 lg:pt-48 lg:pb-32 overflow-hidden">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="text-center max-w-3xl mx-auto">
            ...
            >
              <span className="inline-flex items-center px-3 py-1 rounded-full text-xs font-medium bg-indigo-500/10 text-indigo-600 dark:text-indigo-400 border border-indigo-500/20 mb-6 backdrop-blur-sm">
                ✨ The ultimate portfolio builder for students
              </span>
              <h1 className="text-5xl md:text-7xl font-bold tracking-tight mb-8 font-outfit">
                Build a <span className="text-transparent bg-clip-text bg-gradient-to-r from-indigo-500 to-purple-500 dark:from-indigo-400 dark:to-purple-400">Stunning</span> Portfolio in Minutes
              </h1>
      ...
      {/* Features Grid */}
      <section id="features" className="py-24 border-t border-black/5 dark:border-white/5 bg-black/[0.02] dark:bg-black/10 backdrop-blur-sm">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {[
              ...
              <motion.div
                ...
                className="p-8 rounded-[2rem] t-card hover:border-indigo-500/30 transition-all group hover:-translate-y-1"
              >
                <div className="w-12 h-12 rounded-2xl bg-black/5 dark:bg-white/5 flex items-center justify-center mb-6 group-hover:scale-110 transition-transform border border-black/5 dark:border-white/5">
                  {feature.icon}
                </div>
      ...
      {/* Footer */}
      <footer className="border-t border-black/5 dark:border-white/5 py-12 bg-black/[0.02] dark:bg-black/20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col md:flex-row justify-center items-center gap-8">
          <div className="flex items-center justify-center gap-2">
            <div className="w-6 h-6 bg-slate-200 dark:bg-slate-800 rounded-md flex items-center justify-center font-bold text-xs text-slate-600 dark:text-white">BYP</div>
            <span className="text-sm font-semibold text-slate-500 dark:text-slate-400">© 2026 Build Your Portfolio</span>
          </div>
        </div>
      </footer>
    </div>
